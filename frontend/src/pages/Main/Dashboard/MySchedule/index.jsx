import { useState } from "react";import { Calendar, Badge } from "antd";
...
export const MySchedule = () => {
  ...
  const dateCellRender = (value) => {
    const listData = scheduleData.filter((item) => item.date === value.format("YYYY-MM-DD"));
    return (
        ...
        headerRender={({ value, onChange }) => {
          ...
          return (
            <div className="d-flex justify-content-between align-items-center">
              ...
              />
              <div className="text-white fw-bold">{current.format("MMMM, YYYY")}</div>
              <MBButton
                size={"small"}
                variant={"primary"}
